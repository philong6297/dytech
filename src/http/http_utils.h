...
[[nodiscard]] auto ToMethod(const std::string& method_str) noexcept -> Method;

/* space and case insensitive */
[[nodiscard]] auto
ToVersion(const std::string& version_str) noexcept -> Version;

/* space and case insensitive */
[[nodiscard]] auto
ToExtension(const std::string& extension_str) noexcept -> Extension;

/* space and case insensitive */
[[nodiscard]] auto
ExtensionToMime(const Extension& extension) noexcept -> std::string;
 ...
 */
[[nodiscard]] auto
Split(const std::string& str, const char* delim = SPACE) noexcept
 ...
 */
[[nodiscard]] auto
Join(const std::vector<std::string>& tokens, const char* delim = SPACE) noexcept
  -> std::string;
 ...
 */
[[nodiscard]] auto
Trim(const std::string& str, const char* delim = SPACE) noexcept -> std::string;
 ...
 * * * * * * it
 */
[[nodiscard]] auto Format(const std::string&) noexcept -> std::string;

/**
 * Check if the path-specified directory exists
 */
[[nodiscard]] auto
IsDirectoryExists(const std::string& directory_path) noexcept -> bool;
 ...
 * * * * the
   * cgi-bin folder in resource url path
 */
[[nodiscard]] auto
IsCgiRequest(const std::string& resource_url) noexcept -> bool;

/**
 * Check if the path-specified path exists
 */
[[nodiscard]] auto IsFileExists(const std::string& file_path) noexcept -> bool;

/**
 * Delete a file if exists
 */
[[nodiscard]] auto DeleteFile(const std::string& file_path) noexcept -> bool;
